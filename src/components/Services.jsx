        ...
        <div className='w-full flex justify-center mt-5'>
            <div className='w-full max-w-[1500px] flex flex-col items-center'>
                ...
                <div className='flex flex-col justify-center items-center w-full text-center mb-8'>
                    <span className='dark:text-white text-[40px] font-bold'>Services</span>
                ...
                <div className='flex flex-wrap justify-center gap-5 mt-5'>
                    <div className=' bg-[#ebebeb] dark:bg-white  p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 flex flex-col items-start w-full md:w-[300px]'>
                    ...
                    <div className='dark:bg-white bg-[#ebebeb] p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 flex flex-col items-start w-full md:w-[300px]'>
                        <div className='text-4xl mb-4'>
